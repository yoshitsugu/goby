...
fn ir_binop_to_ast(op: &IrBinOp) -> BinOpKind {
    match op {
        ...
        IrBinOp::Add | IrBinOp::FloatAdd => BinOpKind::Add,
        IrBinOp::Sub | IrBinOp::FloatSub => BinOpKind::Sub,
        IrBinOp::Mul | IrBinOp::FloatMul => BinOpKind::Mul,
        IrBinOp::Div | IrBinOp::FloatDiv => BinOpKind::Div,
        IrBinOp::Mod => BinOpKind::Mod,
        IrBinOp::Eq | IrBinOp::FloatEq => BinOpKind::Eq,
        IrBinOp::Lt | IrBinOp::FloatLt => BinOpKind::Lt,
        IrBinOp::Gt | IrBinOp::FloatGt => BinOpKind::Gt,
        IrBinOp::Le | IrBinOp::FloatLe => BinOpKind::Le,
        IrBinOp::Ge | IrBinOp::FloatGe => BinOpKind::Ge,
    }
}
